package com.example.images.web.service.ImagesServiceImpl;

import com.example.images.dto.ImageDto;
import com.example.images.dto.dao.ImagesRepository;
import com.example.images.web.bom.Image;
import com.example.images.web.converter.ImageConverter;
...
public class ImagesServiceImpl implements ImagesService {
    ...
    public void addNewImage(Image image) {
        ImageDto userImage = imagesRepository.findByUserId(image.getUserId());
        if (userImage != null) {
            // TODO: Create domain exception here
            throw new RuntimeException("User already exist");
        }
        imagesRepository.save(imageConverter.toDto(image));
    }
    ...
    public String getRandomGIF() {
        int a = 0;
        int b = images.length;
        return images[a + (int) (Math.random() * b)];
    }
}
